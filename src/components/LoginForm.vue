  ...
  <div class="container mx-auto h-full flex flex-1 justify-center items-center">
      <div class="w-full max-w-lg w-900">
        ...
        <div class="flex items-center justify-between">
          ...
          <form @submit.prevent="submit" class="w-900 m-4 bg-white p-10 rounded shadow-xl border-2 border-green-600	mt-1">
              ...
              <div class="mb-5 "><img src="../assets/gogreenlogo.png" /></div>
                <div class="">
                  ...
                  <input v-model="fields.email"  class="w-full px-5 py-1 text-gray-400 bg-gray-300 rounded focus:outline-none focus:bg-white" type="email" id="email" aria-label="email" required>
                </div>
                <div class="mt-2">
                  <label class="block  text-sm text-black">Password</label>
                  <input v-model="fields.password" class="w-full px-5 py-1 text-gray-400 bg-gray-300 rounded focus:outline-none focus:bg-white"
                    type="password" id="password" arial-label="password" required>
                </div>
                <div class="mt-4 items-center flex justify-between">
                  <button type="button" class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 hover:bg-gray-800 rounded" @click="$store.dispatch('login', fields)"
