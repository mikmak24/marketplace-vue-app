      ...
      <div class="my-2 flex sm:flex-row flex-col">
        <div class="flex items-center justify-center ">
          <div class="flex border-2 border-gray-200 rounded">
              <input v-model="searchEclipseID" type="text" class="px-4 py-2 w-80" placeholder="Search Eclipse ID...">
              <button @click="getSpecificID(searchEclipseID)" class="px-4 text-white bg-green-600 border-l ">
